								...
								<?php if ($orders->have()) : ?>
									<?php while ($orders->next()) : ?>
										<tr id="<?php $orders->id() ?>">
											...
											<td><img onerror="this.src='<?php $options->themeUrl('assets/img/avatar-default.png') ?>'" referrerpolicy="no-referrer" rel="noreferrer" width="50px" src="<?php $orders->logo() ?>"></td>
