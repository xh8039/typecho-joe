								...
								<form id="sign-up">
									...
									<div class="relative line-form mb10 change-show">
										...
										<span class="yztx abs-right">
											<button type="button" form-action="resetpassword_captcha" class="but c-blue captchsubmit">发送验证码</button>
										</span>
										...
										<input type="hidden" id="_wpnonce" name="_wpnonce" value="e7b8678e87" />
									</div>
									<div class="relative line-form mb10">
									...
									<div class="box-body">
										...
										<button type="button" class="but radius jb-green padding-lg signsubmit-loader btn-block">确认提交</button>
									</div>
								</form>