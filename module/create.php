...
<body class="wp-singular page-template page-template-pages page-template-newposts page-template-pagesnewposts-php page page-id-8 <?= $this->user->hasLogin() ? 'logged-in' : '' ?> wp-theme-zibll white-theme logged-admin nav-fixed site-layout-<?= in_array('post', (array) $this->options->joe_sidebar) ? '2' : '1' ?>">
