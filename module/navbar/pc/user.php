...
<div class="sub-user-box">
	<div class="user-info flex ac relative">
		<a href="<?= joe_relative_url($this->user->permalink) ?>"><span class="avatar-img"><img alt="<?= $this->user->screenName ?>的头像-<?= $this->options->title ?>" src="<?= joe_theme_url('assets/img/avatar-default.png', null) ?>" data-src="<?= joe_avatar_url_by_mail($this->user->mail) ?>" class="lazyload avatar avatar-id-<?= $this->user->uid ?>"></span></a>
		...
		<a href="<?= joe_relative_url($this->options->adminUrl) ?>manage-comments.php" class="msg-news-icon abs-right"><span class="toggle-radius msg-icon"><i class="fa fa-bell-o" aria-hidden="true"></i></span></a>
	</div>
	...
	<div class="mt10 text-center">
		...
		<div class="flex jsa header-user-href">
			...
			<a rel="nofollow" target="_blank" href="<?= joe_relative_url($this->options->adminUrl) ?>plugins.php">
