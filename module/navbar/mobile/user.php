<div class="sub-user-box">
	<div class="user-info flex ac relative">
		<a target="_blank" href="<?= joe_root_relative_link($this->options->adminUrl) ?>profile.php"><span class="avatar-img"><img alt="<?= $this->user->screenName ?>的头像-<?= $this->options->title ?>" src="<?= joe_avatar_lazyload_url() ?>" data-src="<?= joe_get_avatar_by_mail($this->user->mail) ?>" class="lazyload avatar avatar-id-<?= $this->user->uid ?>"></span></a>
		<div class="user-right flex flex1 ac jsb ml10">
			<div class="flex1" style="max-width: calc(100% - 40px);">
				<b><name class="flex ac flex1"><a target="_blank" class="display-name text-ellipsis " href="<?= joe_root_relative_link($this->options->adminUrl) ?>profile.php"><?= $this->user->screenName ?></a></name></b>
				<div class="joe_motto px12 muted-2-color text-ellipsis">这家伙很懒，什么都没有写...</div>
			</div>
		</div>
		<a target="_blank" href="<?= joe_root_relative_link($this->options->adminUrl) ?>manage-comments.php" class="msg-news-icon abs-right"><span class="toggle-radius msg-icon"><i class="fa fa-bell-o" aria-hidden="true"></i></span></a>
	</div>
	...
	<div class="mt10 text-center">
		<div class="flex jsa header-user-href">
			<a rel="nofollow" href="<?= joe_root_relative_link($this->options->adminUrl) ?>profile.php">
			...
			<a rel="nofollow" class="newadd-btns start-new-posts btn-newadd" href="<?= joe_root_relative_link($this->options->adminUrl) ?>write-post.php">
		...
		?>
			<div class="flex jsa header-user-href">
				...
				<a rel="nofollow" target="_blank" href="<?= joe_root_relative_link($this->options->adminUrl) ?>plugins.php"><div class="badg mb6 toggle-radius c-yellow"><i class="fa fa-pie-chart"></i></div>
