...
$joe_index_notice = new \Typecho\Widget\Helper\Form\Element\Textarea(
	'joe_index_notice',
	NULL,
	"fa-home || Joe 主题，优雅极速的 Typecho 主题 || http://blog.yihang.info\rfa-home || 优雅轻量的 Typecho 网站主题：Joe主题！全面开启 || http://blog.yihang.info",
	'首页顶部滚动公告',
	'介绍：用于滚动显示首页轮播图上方的公告，一行一个，请务必填写正确的格式<br>
	格式：FA图标的Class || 内容 || 链接'
);
$joe_index_notice->setAttribute('class', 'joe_content joe_index');
$joe_index_notice->setInputsAttribute('rows', '2');
$form->addInput($joe_index_notice);

$joe_index_notice_theme = new \Typecho\Widget\Helper\Form\Element\Select(
	'joe_index_notice_theme',
	['c-red' => '透明粉红', 'c-yellow' => '透明黄', 'c-blue' => '透明蓝', 'c-green' => '透明绿', 'c-purple' => '透明紫', 'c-red-2' => '透明红', 'c-yellow-2' => '透明橘黄', 'c-blue-2' => '透明深蓝', 'c-green-2' => '透明墨绿', 'c-purple-2' => '透明深紫', 'b-theme sbg' => '主题色', 'b-red sbg' => '红色', 'b-yellow sbg' => '黄色', 'b-blue sbg' => '蓝色', 'b-green sbg' => '绿色', 'b-purple sbg' => '紫色'],
	'c-red',
	'首页顶部滚动公告 - 主题色彩',
);
...
$JIndex_Carousel->setInputsAttribute('rows', '5');
