                ...
                function (require, module, exports) {
                    ...
                    var Grade = (function () {
                        function Grade(container, img_selector, callback) {
                            ...
                            var image = this.container.querySelector(img_selector || 'img');
                            this.gradientData = [];
                            if (!image || !this.container) {
                                return;
                            }
                            ...
                            _this.image.src = image.getAttribute('data-src') || image.getAttribute('src');
                            ...
                            },
                            {
                                ...
                                value: function getChunkedImageData() {
                                    ...
                                    if (!filtered || filtered.length < 2) {
                                        filtered = chunked.filter(function (rgba) {
                                            return (
                            ...
                            },
                            {
                                ...
                                value: function renderGradient() {
                                    ...
                                    if (this.callback) {
                                        ...
                                        this.callback([{ element: this.container, gradientData: top }]);
                                        return;
                                    }
