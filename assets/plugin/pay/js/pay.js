...
(function ($) {
    ...
    function init() {
        ...
        <div class="modal-dialog" role="document">\
            ...
            _win.uri +
            '/assets/plugin/pay/img/alipay-sys.png">\
                        <img class="lazyload pay-sys t-alipay" alt="wechat" src="" data-src="' +
            _win.uri +
            '/assets/plugin/pay/img/wechat-sys.png">\
                    </div>\
                    <div class="row-5">\
                    <div class="pay-qrcon">\
        ...
        $('link#zibpay_css').length || $('head').append('<link type="text/css" id="zibpay_css" rel="stylesheet" href="' + _win.uri + '/assets/plugin/pay/css/main.css?ver=' + _win.ver + '">');
